export const mockProviderDashboard = Object.freeze({
  ...
  offers: Object.freeze([
    Object.freeze({ id: 'offer-demo-1', missionId: 'mission-demo-1', status: 'pending', serviceCategory: 'electricity', request: 'Ổ cắm trong phòng khách bị chập và có mùi khét.', approximateAddress: 'Phước Hải, Nha Trang', distanceKm: 1.8, etaMinutes: 12, expiresAt: new Date(Date.now()+300000).toISOString() }),
