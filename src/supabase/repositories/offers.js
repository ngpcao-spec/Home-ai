...
export function createSupabaseOffersRepository(supabase) {
  ...
  return Object.freeze({
    ...
    async resolveProviderPushMessage(reference) { return unwrap(await client.rpc('resolve_current_provider_push_message',{target_reference:reference}),'offers.resolveProviderPushMessage'); },
